...
const SLIDES: [string, Slide][] = [
  ...
  ['venuetitle', s({ template: 'venuetitle', data: { kicker: 'Where to dance in NY', sub: 'NOCT Guide', name: 'Nowadays', hood: 'Ridgewood, Queens', foot: '56-06 Cooper Ave', image: null, verified: true } })],
  ['venuestory', s({ template: 'venuestory', data: { name: 'Nowadays', note: 'An outdoor floor and a room that runs all night.', says: 'Best outdoor dancefloor in the city.\nWorth the trip for the back room.', foot: 'Ridgewood, Queens' } })],
