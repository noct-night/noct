 ...
 * the whole studio -- the endpoints it calls, the shape of a post, what the buttons do -- and none of that
...
(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    fetch('/api/session', {
      ...
      // A fresh load is what fetches the studio half, which the server would not have sent before now.
