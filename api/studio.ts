/**
 * POST /api/studio   — exchange the studio password for a session cookie
 * DELETE /api/studio — drop the session
 *
 ...
 * against. It is one password in front of one person's review queue, not an identity system, and the thing
